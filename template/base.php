    		...
    		<ul class="list-unstyled ps-0">
    			...
    			<li class="listEl mb-1">
    				...
    				<div class="collapse px-3" id="team-collapse">
    					<ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
    						<li><a href="./team.php?page=add" class="link-light d-inline-flex text-decoration-none rounded">Add</a></li>
    			...
    			<li class="listEl mb-1">
    				...
    				<div class="collapse px-3" id="race-collapse">
    					<ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
    						<li><a href="./race.php?page=add" class="link-light d-inline-flex text-decoration-none rounded">Add</a></li>
    			...
    			<li class="listEl mb-1">
    				...
    				<div class="collapse px-3" id="season-collapse">
    					<ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
    						<li><a href="./season.php?page=add" class="link-light d-inline-flex text-decoration-none rounded">Add</a></li>
