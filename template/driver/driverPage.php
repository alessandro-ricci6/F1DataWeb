...
<?php $driver = $templateParams['driver'];
    ...
    <!-- Modal -->
<div class="modal fade" id="modifyContractModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" data-bs-contract="" onclick="deleteContract()">Delete Contract</button>
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
        <button type="button" class="btn btn-primary" data-bs-contract="" id="saveBtn" onclick="saveContract()">Save</button>
      </div>
    </div>
  </div>
</div>
